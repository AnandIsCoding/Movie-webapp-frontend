...
function Sidebar() {
  return (
    <div className='w-[20vw] min-h-screen bg-[#171717] border-r-2 border-white text-white px-3 py-3'>
       ...
       <button className='flex gap-2 text-2xl ml-8 w-full mr-2 px-3 py-2 rounded-lg  hover:bg-blue-200 hover:text-black '> <FaFire/> Trending </button>
